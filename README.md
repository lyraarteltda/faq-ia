...
Gere uma central de perguntas frequentes publicável: um widget de accordion pronto para colar no seu site + o bloco schema.org FAQPage (elegível a rich results do Google).
