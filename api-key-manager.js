...
const ApiKeyManager = (function() {
  const STORAGE_PREFIX = 'faq-ia_apikey_';
  ...
  const ENABLED_SERVICES = ['openrouter', 'openai']; // texto multi-modelo via OpenRouter (uma chave alcança todos) + OpenAI nativo
  ...
  // Refreshed against the live OpenRouter catalog on 2026-09-12 — every id verified
  // to resolve on GET /api/v1/models (COR-048).
  const AI_MODELS = {
    claude: {
    ...
    google: {
      ...
      models: [
        ...
        { id: 'google/gemini-2.5-flash', name: 'Gemini 2.5 Flash (rápido)' }
      ]
    },
    deepseek: {
      label: 'DeepSeek',
    ...
    trending: {
      ...
      // Live OpenRouter ranking, 2026-09-12.
      models: [
        { id: 'x-ai/grok-4.6', name: 'Grok 4.6 (xAI)' },
        { id: 'moonshotai/kimi-k2', name: 'Kimi K2 (Moonshot)' },
        { id: 'z-ai/glm-4.6', name: 'GLM-4.6 (Z.ai)' },
